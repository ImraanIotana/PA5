...
begin {
    ...
    [PSCustomObject]$Global:ApplicationObject = @{
        ...
        Version                     = [System.Version]'5.7.1.377'
        # Folder Handlers
        ...
        PowerShellExecutablePath    = [System.String](Join-Path -Path $ENV:windir -ChildPath 'System32\WindowsPowerShell\v1.0\powershell.exe')
        # Message Handlers
